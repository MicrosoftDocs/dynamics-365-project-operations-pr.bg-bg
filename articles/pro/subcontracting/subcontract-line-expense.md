...
description: Тази статия обяснява как да записвате линии на подизпълнители за разход и да използвате полета, за да документирате купуването на време от доставчици.
author: rumant
ms.date: 09/14/2022
ms.topic: article
