---
title: Управление на множество клиенти в редове от оферти за проекти
description: Тази статия описва как да управлявате множество клиенти в редове от оферти за проекти.
author: rumant
ms.date: 10/06/2020
ms.topic: article
