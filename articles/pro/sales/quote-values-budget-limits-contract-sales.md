---
title: Подробности за заглавието за оферти по проект
description: Тази статия предоставя информация за информацията и настройките, които се отнасят за оферти на проекта и влияят върху тях. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9824801"
---
# <a name="header-details-for-project-quotes"></a>Подробности за заглавието за оферти по проект
