---
title: Нанасяне на проекти и задачи в аспекти на договор по проект
...
ms.locfileid: "9825045"
---
# <a name="map-projects-and-tasks-to-a-project-contract-line"></a>Нанасяне на проекти и задачи в аспекти на договор по проект 
...
В редовете на договор за проект можете да съпоставите конкретни задачи в проект в реда на договора.
...
## <a name="associate-tasks-to-project-contract-lines"></a>Свързване на задачи към редове от договор за проект
