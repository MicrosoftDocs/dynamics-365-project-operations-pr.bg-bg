---
title: Нанасяне на проекти и задачи в редове с оферти за проекти
description: Тази статия предоставя информация за това как да съпоставяте проекти и задачи с редове от оферти за проекти.
author: rumant
ms.date: 10/05/2020
ms.topic: article
...
ms.locfileid: "9824195"
---
# <a name="map-projects-and-tasks-to-project-quote-lines"></a>Нанасяне на проекти и задачи в редове с оферти за проекти

_**Отнася се за:** Project Operations за сценарии, базирани на ресурси / без складови наличности, внедряване на Lite - сделка с проформа фактуриране_

В редовете с оферти за проект можете да нанесете конкретните задачи на проект, който вече е свързан с ред от оферта.
