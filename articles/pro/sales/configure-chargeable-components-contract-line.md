...
description: Тази статия предоставя информация за това как да добавите таксуеми компоненти към договорни линии в Project Operations.
author: rumant
ms.date: 10/08/2020
ms.topic: article
...
Линията на договора за проект включва *компоненти* и *облагаеми* компоненти.
