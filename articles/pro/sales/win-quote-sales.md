---
title: Затваряне на оферти по проект
...
ms.locfileid: "9826162"
---
# <a name="close-project-quotes"></a>Затваряне на оферти по проект
...
## <a name="closing-a-quote-as-lost"></a>Затваряне на цитат като изгубен
