---
title: Импортиране на приблизителни оценки от проект в ред на оферта за проект
description: Тази статия предоставя информация за това как да импортирате приблизителни оценки от проект в ред на оферта за проект.
author: rumant
ms.date: 10/09/2020
ms.topic: article
...
ms.locfileid: "9824473"
---
# <a name="import-estimates-from-a-project-to-a-project-quote-line"></a>Импортиране на приблизителни оценки от проект в ред на оферта за проект 
