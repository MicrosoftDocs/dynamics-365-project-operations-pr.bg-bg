...
description: Тази статия предоставя информация за настройването на изискуеми и необлагаеми компоненти в ред от оферта, базиран на проект.
author: rumant
ms.date: 03/30/2021
ms.topic: article
