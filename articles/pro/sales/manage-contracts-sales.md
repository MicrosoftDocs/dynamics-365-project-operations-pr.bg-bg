...
description: Тази статия предоставя информация за прегледа на базирани на проект договори.
author: rumant
ms.date: 10/26/2020
ms.topic: article
...
> [!NOTE]
> Договори, които имат проекти, задачи, оценки, дневници и/или действителни данни, свързани с тях, не могат да бъдат изтрити. 
