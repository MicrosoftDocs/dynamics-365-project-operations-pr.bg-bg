...
description: Тази тема предоставя общ преглед на процеса за надграждане от Microsoft Dynamics 365 Project Service Automation до Dynamics 365 Project Operations.
author: ruhercul
...
Развълнувани сме да обявим първата от трите фази за надграждане от Microsoft Dynamics 365 Project Service Automation до Dynamics 365 Project Operations. Тази тема предоставя общ преглед за клиенти, които се впуснат в това вълнуващо пътуване. Бъдещите теми ще включват съображения и подробности за подобренията на функциите. Те не само ще предоставят насоки, които да ви помогнат да се подготвите за надстройването си до Project Operations, но и ще обяснят какво можете да очаквате, след като сте надстроили.

Програмата за доставка на надстройка ще бъде разделена на трите фази.

| Ъпгрейд доставка | Фаза 1 (януари 2022 г.) | Фаза 2 (Април вълна 2022) | Фаза 3 (Април вълна 2022) |
|------------------|------------------------|---------------------------|---------------------------|
...
| Потвърждаване | Фаза 1 (януари 2022 г.) | Фаза 2 (Април вълна 2022) | Фаза 3 (Април вълна 2022) |
|-------------|------------------------|---------------------------|---------------------------|
...
| WBS ще бъде валидиран спрямо известните граници на настолния клиент на Project. | | :heavy_check_mark: | :heavy_check_mark: |
...
- Целевата среда не трябва да съдържа никакви записи в **обекта на** msdyn_projecttask.
...
- Целевата среда трябва да бъде актуализирана до издание 38 или по-нова актуализация за автоматизация на project Service.
...
Като отправна точка импортирайте всички персонализации в чиста среда на Project Operations (lite), за да потвърдите, че импортирането е успешно, и че бизнес операциите се държат според очакванията.
...
2. Изберете **Инсталиране**, за да стартирате надстройката. Центърът за Power Platform администриране ще представи тази инсталация като нова инсталация. Въпреки това ще бъде открит наличието на по-стара версия на Project Service Automation и съществуващата инсталация ще бъде надстроена.
...
3. Надстройте персонализирани решения според случая. В този момент разположите всички промени, които сте направили в персонализациите си в [секцията Тестване и рефракториране на персонализации](#testing-and-refactoring-customizations) на тази тема.
4. Отидете на **Решения за настройки, и изберете да** \> **деинсталирате** решението **"Демортирани компоненти** на операциите по проекта".
...
Възможностите за планиране на проекта в Project Operations вече не разчитат на комбинация логика от страна на клиента и логика от страна на сървъра. Вместо това Project Operations използва Project за уеб, тъй като е планиране двигател. Тази промяна в възможностите за планиране позволява няколко нови функции, като изгледи на дъска и Гант, планиране, управлявано от ресурси, елементи от списък за проверка на [задачите и режими на планиране на](https://support.microsoft.com/office/use-task-checklists-in-microsoft-project-for-the-web-c69bcf73-5c75-4ad3-9893-6d6f92360e9c) проекти. Новите възможности за планиране също се поддържат от богат набор от нови [интерфейси за програмиране на приложения (API)](../project-management/schedule-api-preview.md). Тези API са предназначени да помогнат да се гарантира, че нито една програмна операция за създаване, актуализиране или изтриване на обект в WBS повреди изчислените полета в графика.
...
| Управление и счетоводство на проекти за финанси              | Project Operations за сценарии, базирани на наличност/поръчка за производство | Понастоящем не се поддържа |
