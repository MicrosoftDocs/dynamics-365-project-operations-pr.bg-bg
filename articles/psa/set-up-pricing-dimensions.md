...
description: Тази статия предоставя информация за настройването на персонализирани величини за ценообразуване.
author: Rumant
ms.custom:
...
Преди да започнете, тази статия предполага, че сте завършили процедурите в статиите, [Създаване на персонализирани полета и обекти](create-custom-fields-entities.md) и [Добавяне на персонализирани полета към настройка на цени и транзакционни обекти](field-references.md). Ако не сте завършили тези процедури, върнете се и ги завършете и след това се върнете към тази статия. 

Тази статия предоставя информация за настройването на персонализирани величини за ценообразуване. В уеб интерфейса на Project Service, на страницата **Параметри**, разделът **Ценови измерения, базирани на суми** показва записите в обекти на ценови измерения. По подразбиране инсталирането на Project Service създава 2 реда в мрежата в този раздел:
