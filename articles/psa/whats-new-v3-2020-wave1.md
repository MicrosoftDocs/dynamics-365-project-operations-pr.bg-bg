...
description: Тази статия предоставя информация за това, което е ново и се променя в Project Service Автоматизация версия 3 вълна 1 2020.
ms.custom:
...
Статията подчертава ключови съображения за надстройване при преминаване към най-новото издание на Project Service Automation (PSA) версия 3.x вълна 1 2020.
