...
description: Тази статия предоставя информация за използването на категория транзакции като ниво на ценообразуване.
author: Rumant
ms.custom:
...
Тази статия показва как да използвате категория транзакции като ниво на ценообразуване. Преди да започнете, ако все още не сте създали решение за ценово измерение, ще трябва да създадете ново. Ако вече имате решение за ценово измерение, можете да направите промените си в това решение. Ако не сте създали ново решение за ниво на аналитичност за ценообразуване за вашата организация, попълнете процедурите в статията Създаване на [персонализирани полета и обекти](create-custom-fields-entities.md).
