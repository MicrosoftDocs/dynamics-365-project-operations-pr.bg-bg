...
description: Тази статия предоставя общ преглед на размерите на ценообразуването.
author: rumant
ms.custom:
...
Ако имате нужда от цена или разход за вашите ресурси с помощта на допълнителни атрибути, можете да създадете персонализирани полета, обекти и измерения. За повече информация вижте следните статии, обаче имайте предвид, че трябва да завършите процедурите в реда, посочен по-долу:
