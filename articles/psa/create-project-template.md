...
- **Съставна структура на работата**: Съставна структура на работата в шаблон на проект притежава същия набор от елементи както проекта. Можете да създадете йерархия на задачите, да свържете роли към задача, да дефинирате атрибути на графика, да зададете зависимости и да прегледате всички данни в Гант. Структурата на разбивката на работата в шаблоните на проекта също поддържа режими на задачи за всяка задача. Няма разлика между шаблон на проект и проект при създаване на работен график.  
...
## <a name="create-a-project-template-from-an-existing-project"></a>Създаване на шаблон за проект от съществуващ проект
Можете да създадете шаблон за проект от проект по следните начини:

- **Структура** на разбивката на работата: Структура на разбивката на работата в шаблон, който е получен от проект, ще копира всички задачи и зависимости. Назначенията, които са създадени, ще се основават на членовете на родовия екип, които се добавят към екипа на проекта при създаването на шаблона за проект.
- **Прогнози за** проекта: Когато шаблон за проект е създаден от съществуващ проект, прогнозите от проекта източник се копират в шаблона на проекта.
- **Членове на** екипа на проекта: Когато шаблон е създаден от съществуващ проект, всички наименувани членове на екипа се заменят с генеричния ресурс на организацията. Запазват се всички имена на позиции и роли.

## <a name="create-a-project-from-a-template"></a>Създаване на проект от шаблон  
 Можете да създадете проект от шаблон по следните начини:  
