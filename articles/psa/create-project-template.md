...
## <a name="create-a-project-template-from-an-existing-project"></a>Създаване на шаблон на проект от съществуващ проект
Можете да създадете шаблон на проект от даден проект по следните начини:

- **Структура на разбивката на работата**: Структура на разбивка на работата в шаблон, който е извлечен от проект, ще копира всички задачи и зависимости. Заданията, които се създават, ще се основават на общите членове на екипа, които се добавят към екипа на проекта, когато се създава шаблонът на проекта.
- **Оценки на проекта**: Когато се създава шаблон на проект от съществуващ проект, оценките от изходния проект се копират в шаблона на проекта.
- **Членове на екипа на проекта**: Когато се създаде шаблон от съществуващ проект, всички посочени членове на екипа се заменят с общия ресурс на организацията. Всички имена на позиции и роли се поддържат.
