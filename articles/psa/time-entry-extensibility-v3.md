---
title: Персонализиране на седмичен запис за време
description: Тази статия предоставя информация как да се приложат персонализираните бизнес правила, които поддържат практиките на организацията.
author: stsporen
ms.custom:
...
Секцията **Измерения** не позволява вградено редактиране. Тази секция се поддържа от изглед, който позволява добавяне на персонализирани полета към мрежата за седмични записи за време. За информация как да добавите персонализирани полета вижте раздела „Разширяемост“ по-нататък в тази статия.
