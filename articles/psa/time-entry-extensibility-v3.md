...
description: Тази статия предоставя информация как да внедрите персонализирани бизнес правила, които поддържат практиките на дадена организация.
author: stsporen
ms.custom:
...
Секцията **Измерения** не позволява вградено редактиране. Тази секция се поддържа от изглед, който позволява добавяне на персонализирани полета към мрежата за седмични записи за време. За информация как да добавите персонализирани полета вижте раздела "Разширяемост" по-късно в тази статия.
