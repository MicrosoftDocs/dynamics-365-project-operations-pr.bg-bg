...
description: Тази статия обяснява как да създадете набори от опции и обекти в собственото си решение в Power Apps платформата.
author: Rumant
ms.custom:
...
Процедурите в тази статия трябва да бъдат завършени с помощта на уеб интерфейса на Project Service Automation (PSA).
