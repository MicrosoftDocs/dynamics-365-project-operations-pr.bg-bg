...
description: Тази статия предоставя информация за планиране на проекти.
author: ruhercul
ms.custom:
...
Следните статии предоставят информация, която ще помогне на ръководителите на проекти да преценят работата, да преценят разходите за проекти и да прогнозират изискванията за ресурси, като използват инструментите, които се поддържат в PSA:
