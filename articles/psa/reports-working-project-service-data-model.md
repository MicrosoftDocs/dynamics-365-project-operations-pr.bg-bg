...
description: Тази статия предоставя информация за това как да работите с модела на данни.
author: ruhercul
ms.custom:
...
Dynamics 365 Project Service Automation разширява други обекти на приложения и въвежда свои собствени обекти в модела на данни на Common Data Service. Тази статия описва някои от обектите, които ще срещнете в типичните сценарии за отчитане на PSA.
...
![Диаграма, показваща оферта, ред на оферта и релации на проекти.](media/PS-Reporting-image2.png "Диаграма, показваща котировка, линия на котировки и взаимоотношения на проекти")
...
![Диаграма, показваща поръчка, ред на поръчка и релации на проекти.](media/PS-Reporting-image3.png "Диаграма, показваща поръчка, линия на поръчки и взаимоотношения на проекти")
...
![Диаграма, показваща изискване за ресурс и релации на проекти.](media/PS-Reporting-image4.png "Диаграма, показваща изискване за ресурс, линия на поръчка и взаимоотношения на проекти")
...
![Диаграма, показваща релации на характеристики на наличен ресурс.](media/PS-Reporting-image5.png "Диаграма, показваща връзки с характеристики на резервируемите ресурси")
...
![Диаграма, показваща релациите между връзката на трансакцията, произхода и действителните данни.](media/PS-Reporting-image6.png "Диаграма, показваща връзката на транзакцията, произхода и действителните връзки")
