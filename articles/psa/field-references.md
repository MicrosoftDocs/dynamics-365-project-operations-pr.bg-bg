...
description: Тази статия предоставя информация за добавяне на персонализирани полета към настройка на цени и транзакционни обекти.
author: Rumant
ms.custom:
...
Тази статия предполага, че сте завършили процедурите в статията, [Създаване на персонализирани полета и обекти](create-custom-fields-entities.md). Ако не сте завършили тези процедури, върнете се и ги завършете и след това се върнете към тази статия. 
