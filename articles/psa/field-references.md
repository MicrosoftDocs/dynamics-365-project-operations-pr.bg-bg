...
description: Тази статия предоставя информация за добавяне на персонализирани полета към настройка на цени и обекти за транзакции.
author: Rumant
ms.custom:
...
Тази статия предполага, че сте завършили процедурите в статията [Създаване на персонализирани полета и обекти](create-custom-fields-entities.md) Ако не сте изпълнили тези процедури, върнете се и ги изпълнете, след което се върнете към тази статия. 
