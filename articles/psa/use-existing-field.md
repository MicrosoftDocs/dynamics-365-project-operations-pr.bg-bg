...
description: Тази статия предоставя информация за използването на съществуващите полета на Project Service като величини за ценообразуване.
author: Rumant
ms.custom:
