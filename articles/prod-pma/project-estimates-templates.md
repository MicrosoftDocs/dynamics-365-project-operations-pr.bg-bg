---
title: Синхронизиране на прогнозите за проекти директно от автоматизация на услугата за проекти до финанси и операции
description: Тази тема описва шаблоните и основните задачи, които се използват за синхронизиране на прогнозите за часа на проекта и прогнозите за разходите по проекта директно от Microsoft Dynamics 365 Project Service Automation до Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8684583"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Синхронизиране на прогнозите за проекти директно от автоматизация на услугата за проекти до финанси и операции

[!include[banner](../includes/banner.md)]

Тази тема описва шаблоните и основните задачи, които се използват за синхронизиране на прогнозите за часа на проекта и прогнозите за разходите по проекта директно от Dynamics 365 Project Service Automation до Dynamics 365 Finance.
