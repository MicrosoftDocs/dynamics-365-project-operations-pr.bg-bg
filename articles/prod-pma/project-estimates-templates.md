---
title: Синхронизиране на прогнози за проекти директно от Автоматизация на project Service до финансиране и операции
description: В тази статия се описват шаблоните и основните задачи, които се използват за синхронизиране на прогнозите за час на проекта и прогнозите за разходите по проекта директно от Microsoft Dynamics 365 Project Service Automation до Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9029792"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Синхронизиране на прогнози за проекти директно от Автоматизация на project Service до финансиране и операции

[!include[banner](../includes/banner.md)]

В тази статия се описват шаблоните и основните задачи, които се използват за синхронизиране на прогнозите за час на проекта и прогнозите за разходите по проекта директно от Dynamics 365 Project Service Automation до Dynamics 365 Finance.
...
В шаблона за прогнози за час на проекта трябва да използвате Microsoft Power Query за Excel, за да изпълните тези задачи:
...
- Ако създавате нов шаблон, трябва да добавите тази колона. В Power Query изберете **Добавяне на условна колона** и въведете име за новата колона, например **ModelID**. Въведете условието за колоната, където, ако задачата на проекта не е нула, тогава \<enter the forecast model ID\>; иначе е нула.
...
В шаблона за разчети на разходите по проекта трябва да използвате Power Query, за да изпълните следните задачи:
...
- Ако използвате шаблона за разходи по подразбиране проект (PSA към Fin и Ops), в Power Query, изберете първото **Вмъкнато условие** от секцията **"Приложени стъпки** ". Във **Функцията** влизане, замяна **О\_прогноза** с името на идентификатора на прогнозния модел, който трябва да се използва с интеграцията. Шаблонът по подразбиране има идентификационен номер на прогнозен модел от демонстрационните данни.
- Ако създавате нов шаблон, трябва да добавите тази колона. В Power Query изберете **Добавяне на условна колона** и въведете име за новата колона, например **ModelID**. Въведете условието за колоната, където, ако ИД на ред на прогноза не е нула, тогава \<enter the forecast model ID\>; иначе е нула.
