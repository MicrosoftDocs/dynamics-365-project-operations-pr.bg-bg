---
title: Синхронизиране на категориите разходи по проекта между финанси и операции, и Project Service Automation
description: Тази статия описва шаблон и основните задачи, които се използват за синхронизиране на категории на разход по проект между Microsoft Dynamics 365 Finance и Dynamics 365 Project Service Automation.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9028919"
---
# <a name="synchronize-project-expense-categories-between-finance-and-operations-and-project-service-automation"></a>Синхронизиране на категориите разходи по проекта между финанси и операции, и Project Service Automation

[!include[banner](../includes/banner.md)]

Тази статия описва шаблон и основните задачи, които се използват за синхронизиране на категории на разход по проект между Dynamics 365 Finance и Dynamics 365 Project Service Automation.
