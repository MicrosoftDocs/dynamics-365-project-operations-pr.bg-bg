...
| Управление на проекти и счетоводство | [577857](https://fix.lcs.dynamics.com/Issue/Details/?bugId=577857) | Дебитните и кредитните стойности се превключват, когато добавката за Microsoft Excel се използва с дневника за разходи по проекта и **полето Изместване на тип сметка е зададено на** Project **·**. |
