...
description: Тази статия предоставя информация за актуализациите на качеството, които са налични в октомври 2021 издание на Project Operations за заредени/производство базирани сценарии.
author: andchoi
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
