...
description: Тази статия показва как да настроите фактуриране на проекти между две фирми във вашата организация.
author: Yowelle
ms.date: 07/29/2019
...
Тази статия показва как да настроите фактуриране на проекти между две фирми във вашата организация. Тази задача използва набора от данни USSI.
