---
title: Синхронизирайте действителните данни на проекта директно от Project Service Automation в журнала за интегриране на проекта за публикуване във финанси и операции
description: Тази статия описва шаблони и основните задачи, които се използват за синхронизиране на прогнозни часове на действителни данни за проект директно от Microsoft Microsoft Dynamics 365 Project Service Automation във финанси и операции.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
---
# <a name="synchronize-project-actuals-directly-from-project-service-automation-to-the-project-integration-journal-for-posting-in-finance-and-operations"></a>Синхронизирайте действителните данни на проекта директно от Project Service Automation в журнала за интегриране на проекта за публикуване във финанси и операции

[!include[banner](../includes/banner.md)]

Тази статия описва шаблони и основните задачи, които се използват за синхронизиране на прогнозни часове на действителни данни за проект директно от Microsoft Dynamics 365 Project Service Automation в Dynamics 365 Finance.
