...
Тази статия описва шаблоните и основните задачи, които се използват за синхронизиране на проект действителни директно от Dynamics 365 Project Service Automation към Dynamics 365 Finance.
