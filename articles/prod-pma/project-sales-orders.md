...
description: Тази статия обяснява как да създадете поръчки за продажби въз основа на проекти за проекти за време и материали.
author: Yowelle
ms.date: 04/05/2019
ms.topic: article
ms.prod: ''
...
Тази статия се описва как да създадете поръчка за продажба за проект. Поръчки за продажби могат да се създават само за проекти от типа **време и материал**.
