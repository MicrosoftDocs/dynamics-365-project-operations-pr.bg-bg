...
description: Тази статия предоставя информация за мобилното приложение Microsoft Dynamics 365 Project Timesheet. Мобилното приложение Project Timesheet дава възможност на потребителите да подават и одобряват разписания за проекти на своето мобилно устройство.
author: abruer
ms.date: 06/29/2022
ms.topic: article
ms.prod: ''
...
Мобилното приложение Microsoft Dynamics 365 Project Timesheet дава възможност на потребителите да подават и одобряват разписания за проекти на своето мобилно устройство (iPhone или Android). Това мобилно приложение използва функционалността на хронограмата, която се намира в областта за управление на проекти и счетоводство на Dynamics 365 Finance. Той помага за подобряване на производителността и ефективността на потребителите, а също така помага за навременното въвеждане и одобряване на разписанията на проекти.
...
### <a name="resolve-sign-in-issues"></a>Решаване на проблеми с вписването

**Проблем:** По време на влизане в мобилното приложение Project Timesheet потребителите получават съобщение за грешка, което гласи, че „нямат достъп до приложението '2bc50526-cdc3-4e36-a970-c284c34cbd6e' в този наемател."

**Проблем:** По време на влизане в мобилното приложение Project Timesheet потребителите получават грешка, която прилича на един от следните примери:

- „AADSTS50020: Потребителски акаунт „[потребителско име]“ от доставчик на самоличност“https://sts.windows.net/[app id]" не съществува в клиент „[tenant id]" и няма достъп до приложението „[app id]“ в този клиент.“
- "Избраният потребителски акаунт не съществува в клиента "[ИД на клиента]" и не може да получи достъп до приложението "[ИД на приложението]" в този клиент."

**Обяснение:** Тези проблеми са причинени от промяна, направена в Azure Active Directory (Azure AD) през май 2022 г. и това е свързано с външни потребители. Тъй като тази промяна не е направена за приложения за финанси и операции, тя може да засегне клиенти на всяка версия на платформата или приложението.

**Поправка:** Всички външни потребители трябва да бъдат поканени към наемателя чрез Azure AD. За повече информация вж. [Поканете потребители с Azure Active Directory B2B сътрудничество](/power-platform/admin/invite-users-azure-active-directory-b2b-collaboration).
