...
description: Тази статия предоставя информация за ресурсиране на проекти.
author: Yowelle
ms.date: 09/01/2020
ms.topic: article
ms.prod: ''
...
Тази статия предоставя информация за ресурсиране на проекти.

Едно предизвикателство за мениджърите на проекти и мениджърите на ресурси по време на етапа на планиране на проекта е разпределението на ресурси, където те трябва да определят и запазят правилния ресурс за работа по проект. В Dynamics 365 Finance възможностите за ресурси за проекти Ви позволяват да дефинирате роли, които се третират като временни ресурси, които могат да бъдат запазени за конкретен ангажимент или част от ангажимент. Този тип ресурсно осигуряване нека ръководителите на проекти и мениджърите на ресурси изпълняват следните задачи:
...
Следващите статии предоставят информация за задачите, които трябва да бъдат завършени, когато работите по проекти за ресурси.
