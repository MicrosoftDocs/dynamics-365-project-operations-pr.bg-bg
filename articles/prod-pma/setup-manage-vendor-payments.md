...
description: Тази статия обяснява как да създадете условия, платени при плащане (PWP), така че да можете да освободите частични плащания на доставчици, въз основа на плащания на клиенти.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
