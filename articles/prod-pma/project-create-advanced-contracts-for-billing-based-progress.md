...
description: Тази статия обяснява как да създадете договори за проекти, така че да можете да генерирате фактури за клиенти, въз основа на процент от завършена работа.
author: RadhikaRS
ms.date: 03/26/2020
ms.topic: article
ms.prod: ''
...
Тази статия обяснява как да създадете договори за проекти, така че да можете да създавате фактури за клиенти, въз основа на процент от завършена работа. Сумите на фактурите се изчисляват автоматично за бюджетните категории работа, които сте настроили за даден проект. Времето за фактура се задава, когато договаряте договора за проект с клиента.

Използвайте процедурите в тази статия, за да настроите договор, свързан проект и правилата за фактуриране, които изчисляват сумите от фактури за бюджетните категории работа, които сте задали за проекта.
