...
description: Тази статия описва шаблона и основните задачи, които се използват за синхронизиране на договори за проекти и проекти директно от Microsoft Dynamics 365 Project Service Automation до Dynamics 365 Finance.
author: Yowelle
ms.date: 12/17/2020
ms.topic: article
ms.prod: ''
...
Тази статия описва шаблона и основните задачи, които се използват за синхронизиране на договори за проекти и проекти директно от Dynamics 365 Project Service Automation до Dynamics 365 Finance.
