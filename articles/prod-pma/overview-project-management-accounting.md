...
За повече информация как да обработвате фактури по проекта вижте [Фактуриране на проект](https://docs.microsoft.com/dynamics365/finance/accounts-payable/project-invoicing).
