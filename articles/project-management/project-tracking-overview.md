...
description: Тази статия предоставя информация за това как да проследявате усилието и напредването на работата по проекта.
author: ruhercul
ms.date: 02/15/2022
ms.topic: overview
...
Необходимостта от проследяване на напредъка спрямо графика варира в зависимост от отрасъла. Някои отрасли проследяват на детайлно ниво, докато други отрасли проследяват на по-високо ниво. Тази статия показва как да планирате графика, за да отговорите на изискванията на вашата организация.
...
- Одобреното усилие върху обобщена задача е сумата от одобреното усилие за всички дъщерни задачи плюс одобреното усилие върху обобщената задача.
- Оставащото усилие по обобщаващата задача е сумата от оставащото усилие по всички подчинени задачи минус одобреното усилие по обобщаващата задача.
