...
description: Тази статия предоставя информация и проби за използване на API за график на проекти.
author: sigitac
ms.date: 01/13/2022
ms.topic: article
...
| **API**                                 | Описание                                                                                                                       |
|-----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| **msdyn_CreateProjectV1**               | Този API се използва за създаване на проект. Проектът и сегментът на проекта по подразбиране се създават незабавно.                         |
...
|-------------------------|------------|------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Задача от проект            | Да        | Да        | Да        | Полетата **Напредък**, **EffortCompleted** и **EffortRemaining** могат да се редактират в Project for the Web, но не могат да се редактират в Project Operations.                                                                                                                                                                                             |
...
| Назначаване на ресурс     | Да        | Да\*      | Да        | Не се поддържат операции със следните полета: **BookableResourceID**, **Effort**, **EffortCompleted**, **EffortRemaining** и **PlannedWork**. Записите за възлагане на ресурси не се актуализират. Вместо това може да се изтрие старият запис и да се създаде нов. Предоставен е отделен API за актуализиране на контурите на присвояване на ресурси. |
| Набор на проекта          | Да        | Да        | Да        | Кофата по подразбиране се създава с помощта на **CreateProjectV1** API. Поддръжката за създаване и изтриване на пакети за проекти беше добавена в издание на актуализацията 16.                                                                                                                                                                                                   |
...
| Етикет на проект           | No         | Да        | No         | Имената на етикетите могат да се променят. Тази функция е налична само за Project for the Web                                                                                                                                                                                                                                                                      |
| Задача по проект спрямо етикет   | Да        | No         | Да        | Тази функция е налична само за Project for the Web                                                                                                                                                                                                                                                                                                  |
| Спринт на проект          | Да        | Да        | Да        | Полето **Начало** полето трябва да има дата по-ранна от полето **Край**. Спринтовете за един и същи проект не могат да се припокриват един с друг. Тази функция е налична само за Project for the Web                                                                                                                                                                    |
...
-   Понастоящем етикетите са налични само за Project for the Web.
...
-   **фиксирани единици**
-   календарът на проекта е 9-5p е 9-5pst, понеделник, вторник, четвъртък, петък (НЕ РАБОТИ В СРЯДА)
-   и календарът на ресурсите е 9-1p PST от понеделник до петък

Тази задача е за една седмица, четири часа на ден. Това е така, защото календарът на ресурсите е от 9-1 PST, или четири часа на ден.
...
#### <a name="updatedcontours-sample-payload"></a>Примерен полезен товар на UpdatedContours:
