...
description: Тази статия обяснява как да се създаде структура за разбивка на работата (WBS), включваща основните контроли в новия интерфейс за планиране.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
Задачите могат да бъдат преместени на всяко ниво в структурата на разбивка на работата по един от двата начина:
...
Атрибутите за осигуряване на персонал са достъпни чрез полето **Ресурси** в графика. Можете или да потърсите съществуващ ресурс, или изберете **Създаване** и в прозореца **Бързо създаване** да добавите член на екипа по проекта като нов ресурс.  Когато търсите ресурс, използвайки ресурса в мрежата на задачите, изгледа на борда или gantt, търсенето връща или съществуващи членове на екипа на проекта, или активни ресурси, които могат да бъдат резервирани.
...
Полетата **Роля**, **Ресурсна единица** и **Име на позиция** се използват за описание на изискванията за осигуряване на персонал за задачата. Тези атрибути за осигуряване на персонал заедно с графика на задачите се използват за намиране на налични ресурси за изпълнение на тази задача.
   ...
   - **Роля**: Посочете вида на ресурса, който е необходим за изпълнение на задачата.
...
## <a name="understanding-the-impacts-of-duration-resource-calendars-and-project-calendars-on-tasks"></a>Разбиране на въздействието на продължителността, календарите на ресурсите и календарите на проектите върху задачите
Продължителността на задачата се определя като броя на работните часове между началния час на началната дата и крайния час на крайната дата на задачата.   Проектът за мрежата определя мерните единици за продължителност, както следва:
...
Невъзложените задачи се планират с помощта на календара на проекта. Въпреки това, при първоначалното присвояване на ресурсите, графикът на дадена задача се актуализира така, че да зачита календара на ресурса. Последващите промени в задача, която има задача, ще се уреждат от [начина](scheduling-modes.md) на планиране на проекта. За да научите повече за влиянието на календарите върху задачите, вижте [Ресурсни календари в Проект за уеб](https://techcommunity.microsoft.com/t5/project-blog/resource-calendars-in-project-for-the-web/ba-p/3269686) и [Време за стартиране на задачи & Вашите проекти!](https://techcommunity.microsoft.com/t5/project-blog/task-start-times-amp-your-projects/ba-p/3269665)
...
| Максимален контролен списък на задача                   | 20                   |
