...
description: Тази статия обяснява как да създадете структура на разбивка на работата (WBS) включително на основните контроли в новия интерфейс за планиране.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
Атрибутите за осигуряване на персонал са достъпни чрез полето **Ресурси** в графика. Можете или да потърсите съществуващ ресурс, или изберете **Създаване** и в прозореца **Бързо създаване** да добавите член на екипа по проекта като нов ресурс.  Когато търсите ресурс с помощта на програмата за избор на ресурси в мрежата на задачите, изгледа на дъската или гант, търсенето връща или съществуващи членове на екипа на проекта, или активни резервиращи ресурси.
...
Полетата **Роля**, **Ресурсна единица** и **Име на позиция** се използват за описание на изискванията за осигуряване на персонал за задачата. Тези атрибути за осигуряване на персонал заедно с графика на задачите се използват за намиране на налични ресурси за изпълнение на тази задача.
   ...
   - **Роля**: Задайте вида на ресурса, който е необходим за изпълнение на задачата.,
...
| Максимален контролен списък елементи на задача                   | 20                   |
