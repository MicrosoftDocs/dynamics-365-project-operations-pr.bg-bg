...
description: Тази тема предоставя информация за показателите за ефективност на API на графика на проекта и идентифицира най-добрите практики за оптимално използване.
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
ms.reviewer: kfend
...
Тази тема предоставя информация за показателите за ефективност на интерфейсите за програмиране на приложение (API) на графика на проекта и идентифицира най-добрите практики за оптимизиране на използването.
...
API за график на проекта разчитат на услугата за планиране на проекти за изпълнение на заявки, които са описани по-подробно в следващите раздели на тази тема.
