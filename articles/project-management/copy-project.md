...
С Dynamics 365 Project Operations можете бързо да създавате нови проекти, като използвате **Копиране на проект** действие върху формуляра **Проекти**. За да копирате проект, изберете проект и след това изберете **Копиране**. Действието ще копира:
