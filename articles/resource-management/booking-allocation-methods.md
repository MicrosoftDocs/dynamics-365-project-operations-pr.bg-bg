...
description: Тази статия предоставя информация за това как работят методите за разпределяне на резервации в Project Operations.
author: ruhercul
ms.date: 09/23/2020
ms.topic: article
ms.prod: ''
