...
description: Тази статия предоставя информация, която ще ви помогне да гарантирате, че резервациите на ресурси и зачисленията за проекти са подравнени.
author: ruhercul
ms.date: 01/08/2021
ms.topic: overview
ms.prod: ''
