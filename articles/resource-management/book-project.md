...
description: Тази статия предоставя информация за това как да резервирате ресурс за проект.
author: ruhercul
ms.date: 01/24/2022
ms.topic: article
...
3. Плъзнете изискването върху ресурс и дефинирайте следната информация:
   ...
   > [!NOTE]
   > Понастоящем, Dynamics 365 Project Operations не поддържа таблото за график.   
