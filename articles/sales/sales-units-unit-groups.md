...
description: Тази статия предоставя информация как да създадете единици и единични групи в Dynamics 365 Project Operations.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
За да завършите стъпките в тази статия, се уверете, че сте били присвоени на ролята на системен администратор или професионален мениджър продажби или имате еквивалентни разрешения.
