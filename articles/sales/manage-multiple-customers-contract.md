...
description: Тази статия предоставя информация за това как да управлявате няколко клиента на договор за проект.
author: rumant
ms.date: 11/18/2020
ms.topic: article
