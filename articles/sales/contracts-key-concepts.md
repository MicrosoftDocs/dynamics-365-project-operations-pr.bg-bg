...
description: Тази статия предоставя информация за ключовите концепции на договорите за проекти в Project Operations.
author: rumant
ms.date: 10/07/2020
ms.topic: article
...
Тази статия предоставя ключовите концепции, за да бъдат наясно, преди да започнете да използвате Договори за проекти в Dynamics 365 Project Operations:
