---
title: Концепции, уникални за базирани на проект договори
description: Тази статия предоставя информация за ключовите концепции за договори по проекти в Project Operations.
author: rumant
ms.date: 10/07/2020
ms.topic: article
...
Тази статия предоставя ключовите концепции, с които трябва да се запознаете, преди да започнете да използвате договорите по проект в Dynamics 365 Project Operations:
