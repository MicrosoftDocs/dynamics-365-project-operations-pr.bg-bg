...
description: Тази статия предоставя информация как да актуализирате Project Operations във вашата среда на Dynamics 365 Finance.
author: ruhercul
ms.date: 12/11/2020
ms.topic: article
ms.prod: ''
...
Тази статия предоставя информация как да актуализирате Dynamics 365 Project Operations във вашата среда на Dynamics 365 Finance. Има три процедури, които са необходими за актуализиране на Project Operations до Update 5 (UR5):
...
7. В полето **База за първоначална синхронизация** изберете **Приложения за финанси и операции** и след това изберете **Изпълнение**.
