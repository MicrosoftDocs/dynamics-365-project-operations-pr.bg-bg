...
description: Тази статия предоставя информация за актуализациите на качеството, налични в изданието от юли 2021 г. на Project Operations for resource/non-stocked базирани сценарии.
author: sigitac
ms.date: 07/07/2021
ms.topic: article
ms.prod: ''
