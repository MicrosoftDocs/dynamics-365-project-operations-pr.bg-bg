...
| Обект за интеграция на Project Operations за оценки на разходите (msdyn\_estimateslines) | 1.0.0.2 | Добавен проект договор линия синхронизиране за финансиране и операции приложения за базирани на задачи поддръжка за таксуване. |
| Обект за интеграция на Project Operations за оценки на часове (msdyn\_resourceassignments) | 1.0.0.5 | Добавен проект договор линия синхронизиране за финансиране и операции приложения за базирани на задачи поддръжка за таксуване. |
| Таблица за интегриране на Project Operations за материални оценки (msdyn\_estimatelines) | 1.0.0.0 | Нова карта на таблицата за синхронизиране на оценките на материалите от Dataverse към приложения за финансиране и операции. |
| Обект за експортиране на фактура на доставчик на проект на Project Operations (msdyn\_projectvendorinvoices) | 1.0.0.0 | Нова карта на таблица за синхронизиране на заглавки на фактури за доставчици от приложения за финанси и операции до Dataverse. |
| Обект за линейно експортиране на фактура на доставчик на проект на Project Operations (msdyn\_projectvendorinvoicelines) | 1.0.0.0 | Нова таблица карта за синхронизиране на доставчика фактура редове от финанси и операции приложения до Dataverse. |

Винаги трябва да изпълнявате най-новата версия на картата във вашата среда и да активирате всички свързани карти на таблици, докато актуализирате решението и финансите и версията на решението за операции на Project Operations Dataverse. Някои функции и възможности може да не работят правилно, ако най-новата версия на картата не е активирана. Можете да видите активната версия на картата в колоната **Версия** на страницата **Двоен запис**. Можете да активирате нова версия на картата, като изберете **Версии на табличната карта**, като изберете най-новата версия и след това запишете избраната версия. Ако сте персонализирали предварително подготвена карта на таблицата, приложете отново промените. За повече информация вижте [Управление на жизнения цикъл на приложение](/dynamics365/fin-ops-core/dev-itpro/data-entities/dual-write/app-lifecycle-management).
