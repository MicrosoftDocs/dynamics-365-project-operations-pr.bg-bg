...
4. Ако вашият потребител с пълно име „Spencer Low“ има различен от **„spencerl“** ИД, трябва да актуализирате допълнителен файл. Отворете **DemoDataPreImportConfig.xml** и намерете етикета **userstocreateandconfigure**. Актуализирайте етикета **\<вход\>** с loginId (чувствителен на малки и главни букви). 
