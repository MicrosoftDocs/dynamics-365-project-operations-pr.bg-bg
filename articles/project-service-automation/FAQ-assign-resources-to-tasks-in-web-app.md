...
1. <span data-ttu-id="ad12d-151">В съставната структура на работата изберете задача.</span><span class="sxs-lookup"><span data-stu-id="ad12d-151">On the work breakdown structure, select a task.</span></span>
