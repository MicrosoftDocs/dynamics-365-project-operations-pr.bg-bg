...
Облачно хостваните среди трябва да бъдат разположени с помощта на съществуващ абонамент за Azure. Тази статия обяснява как да свържете съществуващия си абонамент за Azure с проект на LCS. 
...
5. На екрана **Настройка на Microsoft Azure** изберете **Напред**, за да потвърдите. Ако получите грешка на този екран, върнете се към секцията [Предоставяне на достъп на услуги за разполагане на Dynamics до абонамент](#provide) за Azure в тази статия и се уверете, че сте завършили всички стъпки.
