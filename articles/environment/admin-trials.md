...
description: Тази статия предоставя информация за това как да внедрите пробна версия на Dynamics 365 Project Operations.
author: ruhercul
ms.date: 01/10/2022
ms.topic: article
...
Тази статия обяснява как да се абонирате за офертата за партньор за визуализация и да внедрите среда на Dynamics 365 Project Operations.
...
4.  Изберете съответния URL адрес на Microsoft Dataverse и URL адресите на приложения за финанси и операции за валидиране на внедряването.

## <a name="configuring-dual-write"></a>Конфигуриране на двукратно записване
- За да конфигурирате роли за защита за двойно писане, вижте [Актуализирайте настройките за сигурност на Project Operations в Dataverse](resource-provision-new-environment.md#update-security-settings-on-project-operations-on-dataverse).
- За достъп до конфигурация за двойно записване, отидете до екземпляр за финанси и операции, след което отидете до **Управление на данни** > **Двойно записване**.
- За да конфигурирате карти с двойно писане, вижте [Стартирайте карти с двойно записване на Project Operations](resource-provision-new-environment.md#run-project-operations-dual-write-maps).
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>Ами ако изисквам ALM или ELM за моя среда на приложения на приложения за финанси и операции?
