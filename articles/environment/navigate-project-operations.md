...
description: Тази статия предоставя информация как да получите достъп до Операции по проекта от услуги за жизнения цикъл.
author: sigitac
ms.date: 10/28/2020
ms.topic: article
...
След като предоставите Project Operations, както е описано в тази статия, страницата с подробни данни **за услугите за жизнения цикъл (LCS)** предоставя лесен достъп до двата компонента на Project Operations.  
