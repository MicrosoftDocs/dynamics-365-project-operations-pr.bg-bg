...
За да използвате тези разширени възможности за разходи, инсталирайте добавката услуга за управление на разходите за Microsoft Dynamics 365 Finance и включете функциите във вашия екземпляр. Можете да получите достъп до добавката от вашия проект в Microsoft Dynamics lifecycle Services (LCS).
...
- Разписки ще бъдат обработени чрез Microsoft Azure когнитивни услуги, и метаданни ще бъдат извлечени и добавени.
...
Наличността на тази функция в различни региони е посочена в следващата таблица. Ако регионът Ви в момента не се поддържа, подайте заявка за приоритет на наличността на oCR услугата във вашия регион. 
...
| АУС    | Да                               |
| ЕС     | Частично. Английски разписки само. |
| Азия   | No                                |
| Япония  | No                                |
| Африка | No                                |
