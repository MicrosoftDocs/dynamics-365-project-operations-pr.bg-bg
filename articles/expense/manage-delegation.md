...
description: Тази статия предоставя информация за начина, по който представител на разходите може да създава и управлява отчети за разходите за друг служител.
author: suvaidya
ms.date: 10/01/2020
ms.topic: article
ms.prod: ''
