...
description: Тази статия предоставя информация как да добавите задължителни персонализирани препратки към полета към обекти и към формуляри и изгледи.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Тази статия предполага, че сте завършили процедурите в статията, [Създаване на персонализирани полета и обекти, които да се използват като нива на ценообразуване](create-custom-fields-entities-pricing-dimensions.md). Ако не сте завършили тези процедури, върнете се и ги завършете и след това се върнете към тази статия. 

В тази статия процедурите ще ви покажат как да добавите задължителните персонализирани препратки към полета към обекти и към елементите на потребителския интерфейс (ПИ) като формуляри и изгледи.
