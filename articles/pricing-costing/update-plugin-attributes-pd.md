...
description: Тази статия предоставя информация как да актуализирате атрибутите на добавката за величините за ценообразуване.
author: rumant
ms.date: 11/18/2020
ms.topic: article
...
Тази статия предоставя информация как да актуализирате атрибутите на добавката за величините за ценообразуване.

> [!NOTE]
> Тази статия е приложима само за функциите за оферта и договор в Dynamics 365 Project Operations.

## <a name="prerequisites"></a>Предварителни изисквания
Преди да изпълните стъпките в тази статия, трябва да сте завършили процедурите в следните статии:
...
Ако не сте завършили тези процедури, попълнете ги и след това се върнете към тази статия.
