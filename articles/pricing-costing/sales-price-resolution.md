...
description: Тази статия предоставя информация за това как да разрешите процентите на продажби за приблизителни оценки и действителни данни.
author: rumant
ms.date: 04/07/2021
ms.topic: article
...
## <a name="resolve-sales-rates-on-actual-and-estimate-lines-for-material"></a>Разрешаване на ставки за продажби по реални и прогнозни линии за материал
