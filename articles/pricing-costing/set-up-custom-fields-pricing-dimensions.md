...
description: Тази статия предоставя информация как да настроите нивата на аналитичност за ценообразуване с помощта на персонализирани полета.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Преди да започнете, тази статия предполага, че сте завършили процедурите в статиите, [Създаване на персонализирани полета и обекти](create-custom-fields-entities-pricing-dimensions.md) и [Добавяне на задължителни персонализирани полета към настройка на цени и транзакционни обекти](add-custom-fields-price-setup-transactional-entities.md). Ако не сте завършили тези процедури, върнете се и ги завършете и след това се върнете към тази статия. 

Тази статия предоставя информация за настройването на персонализирани величини за ценообразуване. На страницата **Параметри** разделът **Ценови измерения, базирани на суми** показва записите в обекта за ценови измерения. По подразбиране в мрежата в този раздел има два реда:
