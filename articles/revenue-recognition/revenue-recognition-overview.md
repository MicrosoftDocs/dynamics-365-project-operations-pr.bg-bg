...
description: Тази статия предоставя информация за признаване на приходи в Project Operations.
author: sigitac
ms.date: 11/16/2020
ms.topic: overview
...
В Dynamics 365 Project Operations принципите за признаване на приходите варират в зависимост от избрания метод за фактуриране за проект или част от проекта. Тази статия предоставя информация за признаване на приходи в Project Operations.
