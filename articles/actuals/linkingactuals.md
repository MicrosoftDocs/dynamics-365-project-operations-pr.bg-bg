...
description: Тази тема обяснява как концепцията за произхода на транзакциите се използва за свързване на действителните данни с оригинални записи на източници, като запис във времето, запис на разходи или регистрационни файлове за използване на материали.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
